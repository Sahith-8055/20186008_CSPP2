 ...
 * Class List.
 *
 * @param      <E>   {Parameter which is different}
 */
public class List<E> {
    private E[] list;
    private int size;
    ...
    /**
     * Method to add all the items to the list.
     *
     ...
     *
     * @return     {Size, which is an integer}.
     */
    public int size() {
        return size;
    }
    ...
    /**
     * {Method to get the item from a list}.
     *
     * @param      index  The index
     *
     * @return     {Value that is present at that index value}.
     */
